...
const copy = {
  en: {
    hero: {
      ...
      body: "Vyntex connects your CRM, communication, scheduling, payments, automation, websites, and reporting into one organized system.",
      primary: "Book a Consultation",
      secondary: "View Services",
    },
    dashboard: {
      title: "Your Business, Connected",
      body: "Customers, appointments, messages, payments, tasks, and performance in one organized view.",
    ...
    offer: {
      ...
      items: [
        ["CRM & Operations", "Organize customers, leads, appointments, tasks, and team activity."],
        ["Automation & Comm", "Automate follow-up, reminders, intake, messages, and routine updates."],
        ["Web, Marketing & AI", "Capture leads, improve your online presence, and add practical AI."],
      ],
      cta: "View Services",
    },
    difference: {
  ...
  es: {
    hero: {
      ...
      body: "Vyntex conecta su CRM, comunicación, citas, pagos, automatización, web y reportes en un sistema organizado.",
      primary: "Reservar una Consulta",
      secondary: "Ver Servicios",
    },
    dashboard: {
      title: "Su Negocio, Conectado",
      body: "Clientes, citas, mensajes, pagos, tareas y rendimiento en una sola vista organizada.",
    ...
    process: {
      ...
      items: [
        ...
        ["3", "Construcción", "Configuramos, probamos y lanzamos su sistema."],
      ],
    },
    industries: {
